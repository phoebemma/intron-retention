...
\`\`\`{# {r, setup, include=FALSE} \# \## Libraries \# library(ggplot2) \# library(tidyverse) \# library(cowplot) \# library(dplyr) \# \# color_scale \<- c("#7fc97f", "#beaed4","#fdc086","#ffff99","#386cb0","#f0027f") \# \# \# source("R/Trainome_functions.R") \# \# knitr::opts_knit$set(root.dir = "C:/projects/Impact-of-age-and-exercise-on-intron-retention/")
