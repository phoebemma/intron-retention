...
alpha_omega_Pre_exc_metadata <- readRDS("data_new/Pre_Exercise/Alpha_Omega_PreExc_metadata.RDS")
...
alpha_omega <- alpha_omega_counts %>% 
  ...
  dplyr::select(transcript_id, all_of(alpha_omega_Pre_exc_metadata$seq_sample_id))
...
filtered <- nonzero %>%
  dplyr::filter(filterByExpr(nonzero[,-1], # exclude the first column
                             ...
                             large.n = 10, 
                             min.prop = 0.7,
                             group = paste(alpha_omega_Pre_exc_metadata$time)))  
...
saveRDS(normalised_ao_counts, "data_new/gene_counts/cpm_normalised_PreExc_AO_counts.RDS")
...
saveRDS(normalised_vol_counts, "data_new/gene_counts/cpm_normalised_PreExc_vol_counts.RDS")
...
# load the volume metadata 
ct_metadata <- readRDS("data_new/Pre_Exercise/ct_PreExc_metadata.RDS")
...
saveRDS(normalised_ct_counts, "data_new/gene_counts/cpm_normalised_PreExc_contratrain_counts.RDS")
...
saveRDS(normalised_copd_counts, "data_new/gene_counts/cpm_normalised_PreExc_COPD_counts.RDS")
...
saveRDS(normalised_Relief_counts, "data_new/gene_counts/cpm_normalised_PreExc_Relief_counts.RDS")
...
saveRDS(normalised_SRP102542_counts, "data_new/gene_counts/cpm_normalised_PreExc_SRP102542_counts.RDS")
...
all_metadata <- readRDS("data_new/Pre_Exercise/all_prexercise_metadata.RDS")
...
saveRDS(all_transcripts_reordered, "data_new/gene_counts/all_normalised_PreExc_counts.RDS")
