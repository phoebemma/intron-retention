...
# This file is contained in the R subfolder.
# The following code will set the working directory to the project directory
# This allows us access the /data folder directy
setwd("..")
