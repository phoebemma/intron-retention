...
exercise training (RT) on splicing efficiency (SE) of introns in
skeletal muscle . Using SpliceQ @demelocosta2021 we quantify the
splicing efficiency of introns in RNA sequence data from six RT
...
- `/R`This contains the following sub-folders and scripts with codes
  ...
  6.  `/archive/Data_exploration.R` Basic exploration of the old intron
      retention data . This was used before SpliceQ splice junction
      strigency was reduced to 5. The gene annotation used in the
      analysis was generated in this script

  7.  `Trainome_functions.R` Functions created for use in this study or
